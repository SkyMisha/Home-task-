...
class LoginPageLocators:
    ...
    EMAIL_ADDRESS = (By.CSS_SELECTOR, "input[id='id_registration-email']")
    PASSWORD = (By.CSS_SELECTOR, "input[id='id_registration-password1']")
    CONFIRM_PASSWORD = (By.CSS_SELECTOR, "input[id='id_registration-password2']")
